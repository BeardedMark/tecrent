...
@section('admin')
    <a class="fib-button hover-contrast emoji" href="{{ route('games.index', ['trashed' => 'with']) }}">📑
        Все</a>
    <a class="fib-button hover-contrast emoji" href="{{ route('games.index', ['trashed' => 'not']) }}">📄
        Опубликованные</a>
    <a class="fib-button hover-contrast emoji" href="{{ route('games.index', ['trashed' => 'only']) }}">🗑️
        Коризна</a>
        <a class="fib-button hover-accent emoji" href="{{ route('games.create') }}">➕
            Добавить</a>
@endsection
